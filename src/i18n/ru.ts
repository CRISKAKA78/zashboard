...
const ru: LANG_MESSAGE = {
  ...
  noExpire: 'Нет',
  updated: 'Обновлено',
  customDashboardVersion: 'Пользовательская версия',
  officialDashboardLatestVersion: 'Последняя официальная версия',
  checkingVersion: 'Проверка версии',
  versionUnavailable: 'Недоступно',
  ...
  currentFallbackRule: 'Текущее резервное правило',
  noEffectiveFallbackRule: 'Включённое резервное правило MATCH или FINAL не найдено.',
  customRules: 'Пользовательские правила',
  customRulesDescription: 'Управление Pre- и Post-правилами без изменения исходной конфигурации.',
  unsavedChanges: 'Есть несохранённые изменения',
  collapse: 'Свернуть',
  manageCustomRules: 'Управлять правилами',
  loading: 'Загрузка…',
  preCustomRules: 'Pre-правила',
  postCustomRules: 'Post-правила',
  preCustomRulesDescription: 'Проверяются до всех правил из исходной конфигурации.',
  postCustomRulesDescription: 'Проверяются после обычных правил, но до MATCH / FINAL.',
  addRule: 'Добавить правило',
  dragToReorder: 'Перетащите для изменения порядка',
  editCustomRule: 'Изменить правило',
  noCustomRules: 'Нет пользовательских правил',
  advancedRawMode: 'Расширенный режим',
  rawRulePlaceholder: 'DOMAIN-SUFFIX,example.com,DIRECT',
  ruleType: 'Тип правила',
  ruleValue: 'Значение правила',
  ruleValuePlaceholder: 'Например, example.com или имя Provider',
  additionalParams: 'Дополнительные параметры',
  deleteCustomRuleConfirm: 'Удалить это правило?',
  customRulesOperationFailed: 'Операция с правилами не выполнена.',
  sourceConfig: 'Исходная конфигурация',
  managedConfig: 'Управляемая конфигурация',
  restoreLatestBackup: 'Восстановить последнюю копию',
  validateConfig: 'Проверить',
  saveValidateReload: 'Сохранить, проверить и перезагрузить',
  customRulesValidationPassed: 'Проверка Mihomo пройдена.',
  customRulesSavedReloaded: 'Правила сохранены, Mihomo перезагружен.',
  restoreCustomRulesConfirm: 'Восстановить последнюю резервную копию?',
  customRulesBackupRestored: 'Копия восстановлена, Mihomo перезагружен.',
  ruleIntelligence: 'Поиск по правилам',
  ruleIntelligenceDescription:
    'Поиск в прямых и локальных Provider-правилах по домену, IP или слову.',
  rulePenetration: 'Полный маршрут правила',
  rulePenetrationDescription:
    'Показывает эффективное правило, целевую политику, цепочку прокси и конечный выход для домена или IP.',
  queryRulePlaceholder: 'Домен, IP или ключевое слово',
  queryKindDomain: 'Совпадение домена',
  queryKindIp: 'Совпадение IP',
  queryKindKeyword: 'Поиск по слову',
  keywordSearchNotice: 'Результаты по слову не являются результатами совпадения трафика.',
  directRuleMatches: 'Прямые правила',
  providerRuleMatches: 'Rule Providers',
  providerRulesLoading: 'Загрузка локальных Provider-правил…',
  localHelperUnavailable: 'Local Helper недоступен. Поиск прямых правил продолжает работать.',
  localHelperPenetrationUnavailable:
    'Local Helper недоступен. Поиск прямых правил работает, но предыдущее RULE-SET может помешать определить эффективный маршрут.',
  providerRulesError: 'Не удалось загрузить локальные Provider-правила.',
  providerRulesPartial: 'Нельзя выполнить поиск в файлах Provider: {count}.',
  refreshProviderRules: 'Обновить правила провайдера',
  format: 'Формат',
  cache: 'Кэш',
  domainRules: 'Домены',
  ipRules: 'IP',
  otherRules: 'Прочие',
  searchProviderRulesPlaceholder: 'Поиск по типу, содержимому, параметрам или исходной записи',
  providerRuleContentSearchNotice:
    'Поиск выполняется по содержимому провайдера и не означает совпадение трафика.',
  rawRule: 'Исходная запись',
  copyRawRule: 'Копировать исходную запись',
  noProviderRulesFound: 'Правила провайдера не найдены.',
  providerRulePageSummary: '{start}–{end} из {matched} совпадений (всего {total})',
  previousPage: 'Предыдущая страница',
  nextPage: 'Следующая страница',
  providerExplorerOffline: 'Local Helper недоступен. Содержимое провайдера нельзя прочитать.',
  providerExplorerUnsupportedFormat: 'Формат этого Rule Provider не поддерживается.',
  providerExplorerLoadFailed: 'Не удалось загрузить этот Rule Provider.',
  localProviderEditable: 'Локальный, доступен для правки',
  providerReadOnly: 'Только чтение',
  addLocalProviderRule: 'Добавить локальное правило',
  editLocalProviderRule: 'Изменить локальное правило',
  localProviderRulePlaceholder: 'Например: DOMAIN-SUFFIX,example.com',
  localProviderOperationFailed: 'Операция с локальным Rule Provider не выполнена.',
  localProviderVersionConflict: 'Локальный Rule Provider изменился. Обновите данные и повторите.',
  localProviderReloadNoBackup: 'Mihomo отклонил перезагрузку, резервная копия недоступна.',
  localProviderRollbackFailed:
    'Mihomo отклонил перезагрузку, восстановить прежний файл не удалось.',
  localProviderRollbackReloadFailed: 'Прежний файл восстановлен, но Mihomo не смог его загрузить.',
  localProviderReloadRestored: 'Mihomo отклонил перезагрузку. Прежний файл восстановлен.',
  localProviderRuleAdded: 'Локальное правило добавлено и загружено.',
  localProviderRuleUpdated: 'Локальное правило изменено и загружено.',
  localProviderRuleDeleted: 'Локальное правило удалено и загружено.',
  deleteLocalProviderRuleConfirm: 'Удалить это локальное правило?',
  providerNameMatch: 'Имя Provider',
  providerNotReferenced: 'Не используется включённым правилом RULE-SET.',
  noRuleMatches: 'Совпадающие правила не найдены.',
  ruleResultsTruncated: 'Показаны только первые 200 результатов.',
  ruleTarget: 'Целевая политика',
  ...
  noSpecificRuleMatched: 'Конкретное правило не найдено',
  ruleRoute: 'Маршрут',
  finalOutbound: 'Конечный выход',
  proxyChainTargetMissing: 'Цель отсутствует в текущем состоянии прокси',
  noEffectiveRuleMatch: 'Нет совпадающего правила или включённого резерва MATCH / FINAL.',
  otherPossibleMatches: 'Другие возможные совпадения',
  proxyChainCycleDetected: 'Обнаружен цикл в цепочке прокси',
