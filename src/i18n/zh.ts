...
const zh: LANG_MESSAGE = {
  ...
  currentFallbackRule: '当前兜底规则',
  noEffectiveFallbackRule: '未识别到已启用的 MATCH 或 FINAL 兜底规则。',
  customRules: '自定义规则',
  customRulesDescription: '在不修改源配置的前提下管理并校验 Pre / Post 规则。',
  unsavedChanges: '有未保存的更改',
  collapse: '收起',
  manageCustomRules: '管理规则',
  loading: '正在加载…',
  preCustomRules: 'Pre 规则',
  postCustomRules: 'Post 规则',
  preCustomRulesDescription: '优先于源配置中的所有规则匹配。',
  postCustomRulesDescription: '在源配置的普通规则之后、MATCH / FINAL 之前匹配。',
  addRule: '添加规则',
  dragToReorder: '拖动排序',
  editCustomRule: '编辑自定义规则',
  noCustomRules: '暂无自定义规则',
  advancedRawMode: '高级原始模式',
  rawRulePlaceholder: 'DOMAIN-SUFFIX,example.com,DIRECT',
  ruleType: '规则类型',
  ruleValue: '规则内容',
  ruleValuePlaceholder: '例如 example.com 或 Provider 名称',
  additionalParams: '附加参数',
  deleteCustomRuleConfirm: '确定删除该自定义规则吗？',
  customRulesOperationFailed: '自定义规则操作失败。',
  sourceConfig: '源配置',
  managedConfig: '托管运行时配置',
  restoreLatestBackup: '恢复最新备份',
  validateConfig: '校验',
  saveValidateReload: '保存、校验并重载',
  customRulesValidationPassed: 'Mihomo 配置校验通过。',
  customRulesSavedReloaded: '自定义规则已保存，Mihomo 已重载。',
  restoreCustomRulesConfirm: '确定恢复最新的自定义规则备份吗？',
  customRulesBackupRestored: '备份已恢复，Mihomo 已重载。',
  ruleIntelligence: '规则智能查询',
  ruleIntelligenceDescription: '按域名、IP 或关键字查询直接规则和本地 Provider 规则。',
  rulePenetration: '完整规则穿透',
  rulePenetrationDescription: '解释域名或 IP 实际命中的规则、目标策略、代理链与最终出口。',
  queryRulePlaceholder: '域名、IP 或关键字',
  queryKindDomain: '域名匹配',
  queryKindIp: 'IP 匹配',
  queryKindKeyword: '关键字搜索',
  keywordSearchNotice: '关键字结果仅搜索规则内容，不代表实际流量命中。',
  directRuleMatches: '直接规则',
  providerRuleMatches: 'Rule Provider 匹配',
  providerRulesLoading: '正在加载本地 Provider 规则…',
  localHelperUnavailable: 'Local Helper 不可用，仍可查询直接规则。',
  localHelperPenetrationUnavailable:
    'Local Helper 不可用，仍可搜索直接规则；如果前面存在 RULE-SET，则无法确定实际出口。',
  providerRulesError: '无法加载本地 Provider 规则。',
  providerRulesPartial: '有 {count} 个 Provider 文件无法查询。',
  refreshProviderRules: '刷新 Provider 规则',
  format: '格式',
  cache: '缓存',
  domainRules: '域名',
  ipRules: 'IP',
  otherRules: '其他',
  searchProviderRulesPlaceholder: '搜索类型、内容、参数或原始规则',
  providerRuleContentSearchNotice: '这里只搜索该 Provider 内的规则内容，不代表实际流量命中。',
  rawRule: '原始规则',
  copyRawRule: '复制原始规则',
  noProviderRulesFound: '未找到 Provider 规则。',
  providerRulePageSummary: '第 {start}–{end} 条，共匹配 {matched} 条（总计 {total} 条）',
  previousPage: '上一页',
  nextPage: '下一页',
  providerExplorerOffline: 'Local Helper 不可用，无法读取 Provider 内容。',
  providerExplorerUnsupportedFormat: '暂不支持该 Rule Provider 格式。',
  providerExplorerLoadFailed: '无法加载该 Rule Provider。',
  localProviderEditable: '本地可编辑',
  providerReadOnly: '只读',
  addLocalProviderRule: '新增本地规则',
  editLocalProviderRule: '编辑本地规则',
  localProviderRulePlaceholder: '例如：DOMAIN-SUFFIX,example.com',
  localProviderOperationFailed: '本地规则集操作失败。',
  localProviderVersionConflict: '本地规则集已发生变化，请刷新后重试。',
  localProviderReloadNoBackup: 'Mihomo 拒绝重载，且 Helper 未返回可用备份。',
  localProviderRollbackFailed: 'Mihomo 拒绝重载，旧规则集恢复也失败。',
  localProviderRollbackReloadFailed: '旧规则集已恢复，但 Mihomo 无法重新加载。',
  localProviderReloadRestored: 'Mihomo 拒绝重载，旧规则集已自动恢复。',
  localProviderRuleAdded: '本地规则已新增并加载。',
  localProviderRuleUpdated: '本地规则已修改并加载。',
  localProviderRuleDeleted: '本地规则已删除并加载。',
  deleteLocalProviderRuleConfirm: '确定删除这条本地规则吗？',
  providerNameMatch: 'Provider 名称',
  providerNotReferenced: '未被已启用的 RULE-SET 规则引用。',
  noRuleMatches: '未找到匹配规则。',
  ruleResultsTruncated: '仅显示前 200 条结果。',
  ruleTarget: '目标策略',
  ...
  noSpecificRuleMatched: '没有更具体的规则命中',
  ruleRoute: '出口路径',
  finalOutbound: '最终出口',
  proxyChainTargetMissing: '当前代理状态中未找到该目标',
  noEffectiveRuleMatch: '未找到匹配规则，也没有可用的 MATCH / FINAL 兜底规则。',
  otherPossibleMatches: '其他可能匹配',
  proxyChainCycleDetected: '检测到循环策略链',
  groupTestUrls: '组测试链接',
  groupTestUrlsTip:
