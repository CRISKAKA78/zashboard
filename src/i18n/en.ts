const en = {
  ...
  noExpire: 'No expiry',
  updated: 'Updated',
  customDashboardVersion: 'Custom version',
  officialDashboardLatestVersion: 'Official latest',
  ...
  currentFallbackRule: 'Current fallback rule',
  noEffectiveFallbackRule: 'No enabled MATCH or FINAL fallback rule was found.',
  customRules: 'Custom rules',
  customRulesDescription:
    'Manage validated Pre and Post rules without modifying the source configuration.',
  unsavedChanges: 'Unsaved changes',
  collapse: 'Collapse',
  manageCustomRules: 'Manage rules',
  loading: 'Loading…',
  preCustomRules: 'Pre rules',
  postCustomRules: 'Post rules',
  preCustomRulesDescription: 'Evaluated before every rule from the source configuration.',
  postCustomRulesDescription: 'Evaluated after source rules and before MATCH / FINAL.',
  addRule: 'Add rule',
  dragToReorder: 'Drag to reorder',
  editCustomRule: 'Edit custom rule',
  noCustomRules: 'No custom rules',
  advancedRawMode: 'Advanced raw mode',
  rawRulePlaceholder: 'DOMAIN-SUFFIX,example.com,DIRECT',
  ruleType: 'Rule type',
  ruleValue: 'Rule value',
  ruleValuePlaceholder: 'example.com or provider name',
  additionalParams: 'Additional parameters',
  deleteCustomRuleConfirm: 'Delete this custom rule?',
  customRulesOperationFailed: 'The custom rules operation failed.',
  sourceConfig: 'Source configuration',
  managedConfig: 'Managed runtime configuration',
  restoreLatestBackup: 'Restore latest backup',
  validateConfig: 'Validate',
  saveValidateReload: 'Save, validate and reload',
  customRulesValidationPassed: 'Mihomo validation passed.',
  customRulesSavedReloaded: 'Custom rules saved and Mihomo reloaded.',
  restoreCustomRulesConfirm: 'Restore the latest custom-rules backup?',
  customRulesBackupRestored: 'Backup restored and Mihomo reloaded.',
  ruleIntelligence: 'Rule intelligence',
  ruleIntelligenceDescription: 'Query direct and local Provider rules by domain, IP, or keyword.',
  rulePenetration: 'Rule penetration',
  rulePenetrationDescription:
    'Explain the effective rule, target policy, proxy chain, and final outbound for a domain or IP.',
  queryRulePlaceholder: 'Domain, IP, or keyword',
  queryKindDomain: 'Domain match',
  queryKindIp: 'IP match',
  queryKindKeyword: 'Keyword search',
  keywordSearchNotice: 'Keyword results search rule content; they are not traffic match results.',
  directRuleMatches: 'Direct rules',
  providerRuleMatches: 'Rule Providers',
  providerRulesLoading: 'Loading local Provider rules…',
  localHelperUnavailable: 'Local Helper unavailable. Direct rule search remains available.',
  localHelperPenetrationUnavailable:
    'Local Helper is unavailable. Direct searches remain available, but an earlier RULE-SET may prevent determining the effective route.',
  providerRulesError: 'Unable to load local Provider rules.',
  providerRulesPartial: '{count} Provider file(s) could not be searched.',
  refreshProviderRules: 'Refresh Provider rules',
  format: 'Format',
  cache: 'Cache',
  domainRules: 'Domain',
  ipRules: 'IP',
  otherRules: 'Other',
  searchProviderRulesPlaceholder: 'Search type, content, parameters, or raw rule',
  providerRuleContentSearchNotice:
    'This searches content inside this Provider; it does not represent a traffic match.',
  rawRule: 'Raw',
  copyRawRule: 'Copy raw rule',
  noProviderRulesFound: 'No Provider rules found.',
  providerRulePageSummary: '{start}–{end} of {matched} matches ({total} total)',
  previousPage: 'Previous page',
  nextPage: 'Next page',
  providerExplorerOffline: 'Local Helper is unavailable. Provider contents cannot be read.',
  providerExplorerUnsupportedFormat: 'This Rule Provider format is not supported.',
  providerExplorerLoadFailed: 'Unable to load this Rule Provider.',
  localProviderEditable: 'Editable local file',
  providerReadOnly: 'Read-only',
  addLocalProviderRule: 'Add local rule',
  editLocalProviderRule: 'Edit local rule',
  localProviderRulePlaceholder: 'For example: DOMAIN-SUFFIX,example.com',
  localProviderOperationFailed: 'The local Rule Provider operation failed.',
  localProviderVersionConflict: 'The local Rule Provider changed. Refresh and try again.',
  localProviderReloadNoBackup: 'Mihomo rejected the reload and no usable backup was returned.',
  localProviderRollbackFailed:
    'Mihomo rejected the reload and the previous rule file could not be restored.',
  localProviderRollbackReloadFailed:
    'The previous rule file was restored, but Mihomo could not reload it.',
  localProviderReloadRestored: 'Mihomo rejected the reload. The previous rule file was restored.',
  localProviderRuleAdded: 'The local rule was added and loaded.',
  localProviderRuleUpdated: 'The local rule was updated and loaded.',
  localProviderRuleDeleted: 'The local rule was deleted and loaded.',
  deleteLocalProviderRuleConfirm: 'Delete this local rule?',
  providerNameMatch: 'Provider name',
  providerNotReferenced: 'Not referenced by an enabled RULE-SET rule.',
  noRuleMatches: 'No matching rules found.',
  ruleResultsTruncated: 'Only the first 200 results are shown.',
  ruleTarget: 'Target',
  ...
  noSpecificRuleMatched: 'No specific rule matched',
  ruleRoute: 'Route',
  finalOutbound: 'Final outbound',
  proxyChainTargetMissing: 'Target unavailable in current proxy state',
  noEffectiveRuleMatch: 'No matching rule or enabled MATCH / FINAL fallback was found.',
  otherPossibleMatches: 'Other possible matches',
  proxyChainCycleDetected: 'Proxy chain cycle detected',
