  ...
  >
    <div class="proxy-chain-path">
      ...
      <span
        ...
        class="badge badge-warning badge-xs ml-1 shrink-0"
      >
...
const proxyChain = computed(() => getProxyChainAnalysis(props.proxy))
