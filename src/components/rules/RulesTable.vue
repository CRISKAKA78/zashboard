<template>
  ...
  <VirtualTable
    ...
    @row-click="handlerProviderClick"
  />
  <VirtualTable
    v-else
    key="rules"
...
const emits = defineEmits<{
  (e: 'openProvider', provider: RuleProvider): void
}>()
...
const providerRowClass = () => 'cursor-pointer'
const handlerProviderClick = (provider: RuleProvider) => emits('openProvider', provider)
